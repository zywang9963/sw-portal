				...
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown active">
							<a href="#" class="dropdown-toggle active" data-toggle="dropdown"><span data-hover="Short Codes">Short Codes</span> <b class="caret"></b></a>
...
<div class="footer_agile_w3ls">
	<div class="container">
		...
		<div class="agileits_w3layouts_logo logo2">
			<h2><a href="index.html">Tennis Court</a></h2>
